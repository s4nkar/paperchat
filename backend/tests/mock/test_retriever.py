"""
Mocked integration tests for the retrieve() orchestrator.

The RRF fusion algorithm itself is tested without mocks in tests/test_rrf.py.
These tests verify that retrieve() calls both the dense store and BM25 store
and returns a fused, deduplicated result — without hitting real embeddings or stores.
"""
